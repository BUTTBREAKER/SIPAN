...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isRefreshablePage) {
        ...
        pullEl.innerHTML =
            '<i class="fa-solid fa-arrow-down"></i><span>Deslizar para actualizar</span>'
                ...
                if (window.scrollY === 0 && touchStartY > 0) {
                    ...
                    if (delta > 40) {
                        ...
                        if (delta > THRESHOLD) {
                            ...
                            pullEl.querySelector('span').textContent =
                                'Soltar para actualizar'
                            pullEl.querySelector('i').className =
    ...
    setInterval(async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (indicator)
                    indicator.style.background = 'var(--status-entregado)'
            } else {
                if (indicator)
                    indicator.style.background = 'var(--status-cancelado)'
            }
        } catch (e) {
