...
<body>
    <div class="header">
        <h1>INVENTARIO DE INSUMOS Y MATERIA PRIMA</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            @php 
                $valor = $item->stock_actual * $item->costo_unitario; 
            ...
            @empty
            <tr>
                <td colspan="7" class="text-center">No hay insumos registrados activos.</td>
            </tr>
            @endforelse
        </tbody>
        <tfoot>
