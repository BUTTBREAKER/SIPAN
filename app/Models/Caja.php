...
class Caja extends BaseModel
{
     ...
     * Optimización Bolt: Utiliza cache en memoria para evitar consultas redundantes.
     */
     ...
     * Optimización Bolt: Consolida la obtención de monto_apertura y totales de movimientos en una sola consulta.
     */
    public function getResumen($id_caja)
    {
        ...
        // Si no se encuentra la caja (poco probable aquí), retornamos valores por defecto
        if (!$res) {
            return ['apertura' => 0, 'ingresos' => 0, 'egresos' => 0, 'esperado' => 0];
        }
