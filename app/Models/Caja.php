...
class Caja extends BaseModel
{
     ...
     * Optimización Bolt: Utiliza caché en memoria para evitar consultas redundantes en el mismo request lifecycle.
     */
    ...
    public function abrir($id_sucursal, $id_usuario, $monto_usd, $monto_bs, $tasa)
    {
        ...
        // Invalida el caché después de abrir una caja
        if ($result) {
     ...
     * Optimización Bolt: Consolidación de 2 consultas en 1 mediante LEFT JOIN y agregación condicional.
     */
    ...
    public function cerrar($id_caja, $id_usuario, $monto_usd, $monto_bs, $tasa, $observaciones = '')
    {
        ...
        // Invalida el caché después de cerrar la caja (se debe limpiar para todas las sucursales por seguridad o buscar la sucursal de esta caja)
        if ($success) {
