...
class Caja extends BaseModel
{
    ...
    /**
     * Bolt Optimization: Request-level cache for the active caja.
    ...
    {
        // Bolt Optimization: Consolidate summary and opening amount fetch into a single query with LEFT JOIN.
        ...
        return [
            'apertura' => (float)$monto_apertura,
            'ingresos' => (float)$ingresos,
            'egresos' => (float)$egresos,
            'esperado' => (float)($monto_apertura + $ingresos - $egresos)
        ];
    }
