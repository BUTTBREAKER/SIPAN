...
class Caja extends BaseModel
{
    ...
    /**
     * Request-level cache for active cash boxes (Bolt Optimization)
     ...
     * Bolt Optimization: Implementado caching a nivel de request para reducir consultas redundantes.
     */
     ...
     * Bolt Optimization: Consolidado en una sola consulta SQL con JOIN para reducir round-trips.
     */
    ...
    public function cerrar($id_caja, $id_usuario, $monto_usd, $monto_bs, $tasa, $observaciones = '')
    {
        ...
        if ($result && isset($caja['id_sucursal'])) {
