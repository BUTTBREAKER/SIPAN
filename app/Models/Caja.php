...
class Caja extends BaseModel
{
     ...
     * Bolt Optimization: Implementa cacheo a nivel de request para reducir consultas repetitivas.
     */
     ...
     * Bolt Optimization: Utiliza un solo query con LEFT JOIN y agregación condicional.
     */
