...
class Cliente extends BaseModel
{
    ...
    /**
     * Obtener clientes de una sucursal con sus estadísticas de compras en una sola consulta
     * Optimización Bolt: Evita N+1 queries al traer conteos y sumas mediante JOIN
     */
