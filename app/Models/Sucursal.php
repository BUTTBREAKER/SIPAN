...
class Sucursal extends BaseModel
{
    ...
    /**
     * Cache de sucursales activas (Optimización Bolt: Request-level caching)
     * @var array|null
     */
     ...
     * Optimización Bolt: Request-level caching para evitar consultas repetitivas en el header.
     */
