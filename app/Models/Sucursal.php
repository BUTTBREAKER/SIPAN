...
class Sucursal extends BaseModel
{
    ...
    /**
     * Bolt Optimization: Request-level cache for active sucursales.
     * @var array|null
     */
     ...
     * Bolt Optimization: Uses request-level cache to avoid redundant queries when loading branch switcher.
     */
