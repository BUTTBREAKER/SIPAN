...
return [
    ...
    new Route(
        'POST',
        '/auth/verificar-clave-sucursal',
        [AuthController::class, 'verificarClaveSucursal'],
    ),
    new Route(
        'GET',
    ...
    new Route(
        ...
        [AuthController::class, 'verificarSucursal'],
    ),
    new Route(
        'POST',
        '/auth/cambiar-sucursal',
        [AuthController::class, 'cambiarSucursal'],
    ),
    ...
    new Route(
        'GET',
        '/cajas/movimientos',
        [CajaController::class, 'movimientos'],
    ),
    new Route(
        'POST',
        '/cajas/movimientos',
        [CajaController::class, 'addMovimiento'],
    ),
    ...
    new Route(
        ...
        [DashboardController::class, 'getNotificaciones'],
    ),
    new Route(
        'POST',
    ...
    new Route(
        'GET',
        '/productos/search',
        [ProductosController::class, 'search'],
    ),
    new Route(
        'GET',
        '/productos/stock-bajo',
        [ProductosController::class, 'stockBajo'],
    ),
    ...
    new Route(
        'GET',
        '/insumos/edit/{id}',
        [InsumosController::class, 'edit'],
    ),
    new Route(
        'POST',
        '/insumos/update/{id}',
        [InsumosController::class, 'update'],
    ),
    new Route(
        'POST',
        '/insumos/delete/{id}',
        [InsumosController::class, 'delete'],
    ),
    new Route(
        'GET',
        '/insumos/search',
        [InsumosController::class, 'search'],
    ),
    new Route(
        'GET',
        '/insumos/stock-bajo',
        [InsumosController::class, 'stockBajo'],
    ),
    ...
    new Route(
        'POST',
        '/recetas/delete/{id}',
        [RecetasController::class, 'delete'],
    ),
    new Route(
        'POST',
        '/recetas/calcular',
        [RecetasController::class, 'calcular'],
    ),
    new Route(
        'GET',
        '/recetas/calcular',
    ...
    new Route(
        'POST',
        '/recetas/add-insumo',
        [RecetasController::class, 'addInsumo'],
    ),
    new Route(
        'POST',
        '/recetas/remove-insumo',
        [RecetasController::class, 'removeInsumo'],
    ),
    ...
    new Route(
        'GET',
        '/clientes/search',
        [ClientesController::class, 'search'],
    ),
    ...
    new Route(
        'POST',
        '/pedidos/registrar-pago',
        [PedidosController::class, 'registrarPago'],
    ),
    new Route(
        'POST',
        '/pedidos/asignar-repartidor/{id}',
        [PedidosController::class, 'asignarRepartidor'],
    ),
    ...
    new Route(
        'GET',
        '/producciones',
        [ProduccionesController::class, 'index'],
    ),
    new Route(
        'GET',
        '/producciones/create',
        [ProduccionesController::class, 'create'],
    ),
    new Route(
        'POST',
        '/producciones/store',
        [ProduccionesController::class, 'store'],
    ),
    new Route(
        'GET',
        '/producciones/show/{id}',
        [ProduccionesController::class, 'show'],
    ),
    ...
    new Route(
        'GET',
        '/auditorias/show/{id}',
        [AuditoriasController::class, 'show'],
    ),
    new Route(
        'POST',
        '/auditorias/deshacer',
        [AuditoriasController::class, 'deshacer'],
    ),
    new Route(
        'GET',
        '/auditorias/estadisticas',
        [AuditoriasController::class, 'estadisticas'],
    ),
    ...
    new Route(
        'GET',
        '/respaldos',
        [RespaldosController::class, 'index'],
    ),
    new Route(
        'POST',
        '/respaldos/generar',
        [RespaldosController::class, 'generar'],
    ),
    new Route(
        'POST',
        '/respaldos/restaurar',
        [RespaldosController::class, 'restaurar'],
    ),
    new Route(
        'GET',
        '/respaldos/descargar/{id}',
        [RespaldosController::class, 'descargar'],
    ),
    ...
    new Route(
        'POST',
        '/sugerencias/generar',
        [SugerenciasController::class, 'generar'],
    ),
    new Route(
        'POST',
        '/sugerencias/aprobar',
        [SugerenciasController::class, 'aprobar'],
    ),
    new Route(
        'POST',
        '/sugerencias/rechazar',
        [SugerenciasController::class, 'rechazar'],
    ),
    new Route(
        'POST',
        '/sugerencias/completar',
        [SugerenciasController::class, 'completar'],
    ),
    ...
    new Route(
        'GET',
        '/predicciones',
        [PrediccionesController::class, 'index'],
    ),
    new Route(
        'GET',
        '/predicciones/data',
        [PrediccionesController::class, 'getDatosVentas'],
    ),
    new Route(
        'POST',
        '/predicciones/generar',
        [PrediccionesController::class, 'generarSugerenciasAutomaticas'],
    ),
    ...
    new Route(
        'GET',
        '/proveedores/create',
        [ProveedoresController::class, 'create'],
    ),
    new Route(
        'POST',
        '/proveedores/store',
    ...
    new Route(
        'GET',
        '/proveedores/edit/{id}',
        [ProveedoresController::class, 'edit'],
    ),
    new Route(
        'POST',
        '/proveedores/update/{id}',
        [ProveedoresController::class, 'update'],
    ),
    new Route(
        'POST',
        '/proveedores/delete/{id}',
        [ProveedoresController::class, 'delete'],
    ),
    new Route(
        'GET',
        '/proveedores/show/{id}',
        [ProveedoresController::class, 'show'],
    ),
    new Route(
        'GET',
        '/proveedores/insumos-sin-proveedor',
        [ProveedoresController::class, 'insumosSinProveedor'],
    ),
    ...
    new Route(
        'GET',
        '/config/refresh-tasa',
        [ConfigController::class, 'refreshTasa'],
    ),
    ...
    new Route(
        'GET',
        '/chat/conversaciones',
        [ChatController::class, 'getConversaciones'],
    ),
    new Route(
        'GET',
        '/chat/usuarios',
        [ChatController::class, 'getUsuarios'],
    ),
    new Route(
        'POST',
        '/chat/conversacion-directa',
        [ChatController::class, 'getOrCreateDirecta'],
    ),
    new Route(
        'GET',
        '/chat/mensajes/{id}',
        [ChatController::class, 'getMensajes'],
    ),
