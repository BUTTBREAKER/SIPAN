...
<form class="row row-cols-1 row-cols-xl-2 row-gap-3" x-data @submit.prevent="
...
">
  ...
  <fieldset class="col d-grid gap-3">
    <legend class="text-center m-0">Información del Negocio</legend>
  ...
  <fieldset class="col d-grid gap-3">
    <legend class="text-center m-0">Información del Administrador</legend>
    ...
    <div>
      <label for="segundo_nombre" class="form-label">Segundo Nombre <sup>(Opcional)</sup></label>
      <input
        id="segundo_nombre"
        name="segundo_nombre"
        class="form-control"
    ...
    <div>
      <label for="segundo_apellido" class="form-label">Segundo Apellido <sup>(Opcional)</sup></label>
      <input
        id="segundo_apellido"
  ...
  <!-- 📌 BOTONES -->
  <footer class="col-xl-12 btn-group">
    <button class="btn btn-danger">Registrar Negocio</button>
