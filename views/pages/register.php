         ...
         setTimeout(() => {
            ...
            window.location.href = 'analytics.html';
                ...
                <form @submit.prevent="submitForm" class="mt-5 xl:mt-7">
                  <div class="space-y-4">
                    <div>
                      <label class="text-sm leading-none inline-block mb-2 font-medium text-default-600" for="name">Full Name</label>
                      <div class="flex-1 w-full">
                        <input type="name" id="name" name="name" x-model="name" :class="errors.name ? 'border-destructive' : 'border-default-300'" class="w-full bg-background border rounded-lg h-12 px-3 text-base text-default-500 focus:outline-none focus:border-primary" placeholder="Enter your name" />
                      </div>
          ...
          <span class="icon-[heroicons--check] w-3 h-3 text-primary-foreground"></span>
                ...
                <div class="mt-5 2xl:mt-8 text-center text-base text-default-600">Already Registered?<!-- -->
                  <a class="text-primary" href="">Sign In</a>
                </div>
              </div>
