                                ...
                                <tbody>
                                    <template x-for="insumo in resultado?.insumos_necesarios" :key="insumo.id_insumo">
                                        <tr :class="!insumo.suficiente ? 'table-danger' : ''">
                                            ...
                                            <td>S/ <span x-text="insumo.costo_total.toFixed(2)"></span></td>
                                        </tr>
                                    </template>
                                </tbody>
                                <tfoot>
                                    <tr class="table-info">
                                        ...
                                        <th>S/ <span x-text="resultado?.costo_total?.toFixed(2)"></span></th>
                                    </tr>
                                    <tr class="table-success">
                                        <th colspan="4">Costo por Unidad</th>
                                        <th>S/ <span x-text="resultado?.costo_por_unidad?.toFixed(2)"></span></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
