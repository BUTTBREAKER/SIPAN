   ...
   submitForm() {
      ...
      if (!this.errors.email && !this.errors.password) {
        ...
        <span class="icon-[heroicons--check] w-3 h-3 text-primary-foreground"></span>
                    ...
                    <a class="flex-none text-sm text-primary" href="forgot3.html">Forget Password?</a>
                  </div>
                ...
                <div class="mt-6 text-center text-base text-default-600">Don't have an account?<!-- -->
                  <a class="text-primary" href="register3.html">
                    <!-- -->Sign Up<!-- --></a>
                </div>
              </div>
