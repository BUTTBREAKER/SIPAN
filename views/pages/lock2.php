   ...
   submitForm() {
      ...
      if ( !this.errors.password) {
         ...
         setTimeout(() => {
            ...
            <div class="2xl:mt-8 mt-6 2xl:text-3xl text-2xl font-bold text-default-900 text-center">Lock Screen</div>
            <div class="2xl:text-lg text-base text-default-600 mt-2 leading-6 text-center">Enter the information you entered while
              registering.</div>
            <div class="mt-6 flex justify-center">
              <span
      class="relative flex shrink-0 overflow-hidden rounded-full h-[72px] w-[72px]"><img
        class="aspect-square h-full w-full" alt="" src="assets/images/avatar/avatar-7.jpg"></span>
            </div>
            <div class="text-center mt-4 text-xl font-medium text-default-900">Karthikeya Marupthy</div>
            ...
            <div class="mt-8 text-center text-base font-medium text-default-600">Not you? Return
              <!-- -->
              <a class="text-primary" href="login2.html">Sign In</a>
            </div>
          </div>
