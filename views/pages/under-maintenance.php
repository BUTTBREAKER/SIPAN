    ...
    <div class="flex flex-col min-h-screen">
      ...
      <div class="flex-1 flex flex-col justify-center">
        <div class="container flex flex-col items-center">
          <div class="w-full h-full lg:w-[700px] lg:h-[432px]"><img class="h-full w-full object-cover" src="assets/images/utility/construction-light.png" /></div>
          <div class="mt-12 lg:mt-20 text-xl md:text-3xl lg:text-5xl font-semibold text-default-900 text-center">We are under maintenance.</div>
          <div class="text-sm md:text-base lg:text-xl text-default-600 mt-4 text-center">We’re making the system more awesome.<br> We’ll be back shortly.</div>
        </div>
      </div>
      <div class="flex-none flex flex-col items-center sm:flex-row  flex-wrap gap-4 p-10">
