  ...
  <div class="flex min-h-svh w-full flex-col bg-[#EEF1F9] dark:bg-background" x-cloak x-show="!$store.app.loading">
    ...
    <div class="min-h-screen  overflow-y-auto flex justify-center items-center p-10">
      <div class="w-full flex flex-col items-center">
        <div class="max-w-[740px]"><img class="w-full h-full object-cover" src="assets/images/error/light-404.png" /></div>
        <div class="mt-16 text-center">
          <div class="text-2xl md:text-4xl lg:text-5xl font-semibold text-default-900">Ops! Page Not Found</div>
