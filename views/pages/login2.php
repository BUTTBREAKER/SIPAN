   ...
   submitForm() {
      ...
      if (!this.errors.email && !this.errors.password) {
         ...
         setTimeout(() => {
            ...
            <div class="2xl:text-lg text-base text-default-600 mt-2 leading-6">Enter the information you entered while registering.</div>
            <form @submit.prevent="submitForm" class="2xl:mt-7 mt-8">
              ...
              <div class="relative mt-6"><input class="w-full bg-background dark:border-700 px-3 file:border-0 file:bg-transparent file:text-sm file:font-medium read-only:bg-background disabled:cursor-not-allowed disabled:opacity-50 transition duration-300 border-default-300 text-default-500 focus:outline-none focus:border-primary disabled:bg-default-200 placeholder:text-accent-foreground/50 border rounded-lg h-12 text-base read-only:leading-[48px] peer" placeholder=" " :type="showPassword ? 'text' : 'password'" id="password" name="password" x-model="password" />
                <label class="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-50 inline-block absolute text-base text-default-600 rounded-t duration-300 transform -translate-y-5 scale-75 top-2 z-10 origin-[0] bg-background px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1" for="password">Password</label>
              ...
              <div class="mt-5  mb-6 flex flex-wrap items-center justify-between gap-2">
        ...
        <span class="icon-[heroicons--check] w-3 h-3 text-primary-foreground"></span>
                ...
                <a class="flex-none text-sm text-primary" href="forgot2.html">Forget Password?</a>
              </div>
              <button class="inline-flex items-center justify-center font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-0 disabled:opacity-50 whitespace-nowrap disabled:pointer-events-none bg-primary text-primary-foreground hover:bg-primary/80 h-11 rounded-md px-[18px] py-[10px] text-base w-full">Sign In</button>
            </form>
            <div class="2xl:mt-8 mt-6 flex flex-wrap justify-center gap-4">
            ...
            <div class="mt-6 text-center text-base text-default-600">Don't have an account? <a class="text-primary" href="register2.html">Sign Up </a>
            </div>
          </div>
