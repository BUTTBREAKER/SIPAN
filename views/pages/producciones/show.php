                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <?= number_format($produccion['cantidad'], 2) ?> unidades
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php 
                                $costo_total = 0;
                                foreach ($insumos_utilizados as $insumo): 
                                    $costo_insumo = $insumo['cantidad'] * $insumo['precio_unitario'];
                                ...
                                <tr>
                                    ...
                                    <td>S/ <?= number_format($insumo['precio_unitario'], 2) ?></td>
                                    <td>S/ <?= number_format($costo_insumo, 2) ?></td>
                                </tr>
                                <?php endforeach; ?>
                            ...
                            <tfoot>
                                <tr class="table-info">
                                    ...
                                    <th>S/ <?= number_format($costo_total, 2) ?></th>
                                </tr>
                                <tr class="table-success">
                                    <th colspan="4" class="text-end">Costo por Unidad:</th>
                                    <th>S/ <?= number_format($costo_total / $produccion['cantidad'], 2) ?></th>
                                </tr>
                            </tfoot>
                            <?php endif; ?>
                        </table>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 p-3 bg-light rounded">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="text-primary">S/ <?= number_format($costo_total, 2) ?></span>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between">
                            <strong>Costo por Unidad:</strong>
                            <span class="text-success fs-5">S/ <?= number_format($costo_total / $produccion['cantidad'], 2) ?></span>
                        </div>
                    </div>
                    <?php else: ?>
